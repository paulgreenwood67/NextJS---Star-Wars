...
//function get data from API and pre-render the paths
...
// function to get the data from the API with the params of the selected film
...
// function to display selected film
const Details = ({ film }) => {
